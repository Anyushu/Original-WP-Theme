...
<img src="<?php echo $wp_url; ?>/lib/images/theme/promo-1.png" class="img-fluid floating" alt="image">
</div>
...
<img src="<?php echo $wp_url; ?>/lib/images/theme/img-1-1200x1000.jpg" class="card-img-top" alt="image">
...
<img src="<?php echo $wp_url; ?>/lib/images/ill/ill-2.svg" class="img-center img-fluid" alt="image">
</div>
</div>
...
<div class="px-4">
<img src="<?php echo $wp_url; ?>/lib/images/theme/team-1-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;" alt="image">
...
<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
<div class="px-4">
<img src="<?php echo $wp_url; ?>/lib/images/theme/team-2-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;" alt="image">
<div class="pt-4 text-center">
<h5 class="title">
...
<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
<div class="px-4">
<img alt="image" src="<?php echo $wp_url; ?>/lib/images/theme/team-3-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
<div class="pt-4 text-center">
<h5 class="title">
...
<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
<div class="px-4">
<img alt="image" src="<?php echo $wp_url; ?>/lib/images/theme/team-4-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
<div class="pt-4 text-center">
<h5 class="title">
